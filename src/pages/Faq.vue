        ...
        <div class="faq-accordion row-fix">
          <q-list bordered>
            <q-expansion-item
              expand-separator
              icon="add"
              label="Чим ваш сервіс може бути корисним?"
            >
              <q-item-section>
                <q-list bordered>
            ...
            <q-expansion-item expand-separator icon="add" label="Як отримати результат оцінки?">
              <div class="p-3">
                ...
                при оформленні. Рекомендуємо переглядати результат оцінки в особистому кабінеті,
                тому що там ви можете отримати додаткову інформацію щодо вашої оцінки.
              </div>
            </q-expansion-item>
            ...
            >
              <div class="p-3">
                ...
                особистого кабінету неможливо.<br />
            ...
            <q-expansion-item
              icon="add"
              expand-separator
              label="Наскільки точні результати оцінки?"
            >
              <div class="p-3">
