<template>
  <div class="bootstrap-scope">
          ...
          <div class="row">
              ...
              <div class="single-ml-services-box">
                <div class="image">
                  <picture>
                    ...
                    <img
                      src="~assets/img/services-image/5.png"
                      alt="Аналіз фотографій нерухомості"
                    />
                  </picture>
                </div>
                <h3>Аналіз фотографій нерухомості</h3>
                <p>
                  Технологія, яка немає аналогів на ринку. В процесі оцінювання за допомогою
                  нейронних мереж оцінюється візуальний стан інтер'єру нерухомості. Це дозволяє
                  досягти максимально точної оцінки.
                </p>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
              <div class="single-ml-services-box">
                ...
                <p>
                  Ми швидко знайдемо для вас в інтернеті схожі оголошення, які ви зможете
                  переглянути та порівняти з вашої нерухомістю.
                </p>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
              <div class="single-ml-services-box">
                ...
                <h3>Безпека</h3>
                <p>
                  Ваші особисті дані та завантажена інформація щодо нерухомості не передаються
                  третім особам. Завантажені дані про нерухомість використовуються виключно для
                  аналізу та оцінки вартості.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="row h-100 justify-content-center align-items-center">
          ...
          <div class="col-lg-6 col-md-12 services-content">
            <div class="section-title">
              ...
              <div class="bar"></div>
              <p>
                Людина фізично неспроможна обробляти і запам'ятовувати необхідну кількість
                інформації, щоб робити точну та актуальну оцінку ринку нерухомості.
              </p>
              <p>
              ...
              <h5 class="highlight-block">
                Відсутніть людського фактору робить аналіз нашою системою максимально точним і
                об'єктивним.
              </h5>
            </div>
          </div>
    ...
    <div class="iot-features-area ptb-80">
      <div class="container">
        <div class="row align-items-center services-content">
          <div class="col-lg-6 iot-features-content section-title">
            <h3>Зручно</h3>
            <div class="bar"></div>
            <p>Вам не треба чекати та викликати оцінювача.</p>
            <p>Не треба сплачувати суттєві кошти за його послуги.</p>
            <p>
              Заповнити невелику форму з основними параметрами вашої нерухомості — це все, що вам
              потрібно зробити. Якщо у вашої нерухомості є будь-який ремонт або оздоблення
              приміщення — зробіть від 3 до 50 фотографій інтер'єру та завантажте їх разом з формою.
              Наша унікальна система штучного інтелекту проаналізує фотографії, що дозволить зробити
              максимально точну оцінку.
            </p>
            <br />
            <h5 class="highlight-block">Весь процес оцінки займе не більше 5 хвилин.</h5>
          </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12">
            <div class="about-image">
              <picture>
                <source srcset="~assets/img/1.png.webp" type="image/webp" />
                <img src="~assets/img/1.png" alt="Сучасно" />
              </picture>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-12">
            <div class="about-content">
              <div class="section-title">
                ...
                <div class="bar"></div>
                <p>
                  Застосування штучного інтелекту стає повсякденним у нашому житті. Сфера
                  нерухомості не є виключенням. Кожен день ми оброблюємо гігабайти інформації та
                  покращуємо наш алгоритм оцінки.
                </p>
                <p>
                ...
                <br />
                <h5 class="highlight-block">
                  Наша мета — надати можливість кожному швидко, якісно і доступно оцінити
                  нерухомість.
                </h5>
              </div>
            </div>
    ...
    <div class="funfacts-area ptb-80" ref="countersRef">
      <div class="container">
        <div class="section-title">
          ...
          <div class="bar"></div>
          <p>
            Ми пишаємося нашими досягненнями і постійно працюємо над покращенням якості наших
            послуг.
          </p>
        </div>
        ...
        <div class="contact-cta-box">
          <h3>Як користуватися сервісом?</h3>
          <p>Спробуйте, це дуже просто</p>
          <router-link :to="{ name: 'manual' }" class="btn btn-primary"
            >Дізнатися більше</router-link
          >
        </div>

        <div class="map-bg">
          <picture>
            <source srcset="~assets/img/map.png.webp" type="image/webp" />
