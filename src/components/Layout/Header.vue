        ...
        <div class="row">
          <div class="col-lg-4 col-md-12 col-sm-12">
            <div class="single-banner-boxes">
              ...
              <p>
                Отримайте точну оцінку за 5 хвилин просто заповнивши форму на сайті та завантаживши
                декілька фотографій.
              </p>
            </div>
          </div>
      ...
      <div class="row align-items-center">
        <div class="col-1">
          <div class="cta-content glory-to-ukraine">
            <img src="~assets/img/ukraine.png" alt="Stand with Ukraine!" style="max-width: 50px" />
          </div>
        </div>
